...
TABLO_HESAPLAR="hesaplar"
INSERT_HESAPLAR="(rezId,HarcamaId,harcamatarihi,paketAdi,tutar,odendi)"
...
hesaplar_main_window = QMainWindow()
hesaplar_ui = Ui_hesap_MainWindow()
hesaplar_ui.setupUi(hesaplar_main_window)
hesaplar_ui.statusbar.setStyleSheet("font: 75 13pt 'Times New Roman'; background-color:rgb(200,200,200)")
...
class MyTableWidget(QTableWidget):
    ...
    def init_ui(self):
        self.setContextMenuPolicy(3)  # ContextMenuPolicy: Qt.CustomContextMenu
...
class rezTakip():
    def __init__(self):
        ...
        self.curs.execute("CREATE TABLE IF NOT EXISTS hesaplar \
            (rezId INT,HarcamaId INTEGER PRIMARY KEY AUTOINCREMENT,harcamatarihi Date,paketAdi Text,tutar Int,odendi Text)") #kişilerin ödemesi gereken tutar ve harcamalar
        ...
        rezTakip_ui.pushButton_harcamaEkle.clicked.connect(lambda : self.hesaplar_ekrani_ac())
    ...
    def hesaplar_ekrani_ac(self,Id=None,otelAdi=None,adSoyad=None,aktivite=None):
        hesaplar_main_window.show()
        ...
        for sutun_index, hucre_verisi in enumerate(satir):
            ...
            if tablo == rezTakip_ui.aktivite_tableWidget:         
                ...
                if sutun_index==0:        
                    ...
                    harcama_button.clicked.connect(lambda : rezTakip().hesaplar_ekrani_ac())
